...
module.exports = function (proto) {
   ...
   *    imgs.append(img1, img2)       gm convert src img1 img2 -append
   *    imgs.append(imgs, true)        gm convert src imgs +append
   *    imgs.append(imgs, false)       gm convert src imgs -append
   *    imgs.append(imgs)              gm convert src imgs -append
   *    imgs.append(imgs).append()     gm convert src imgs -append
   *    imgs.append(imgs).append(true) gm convert src imgs +append
   *    imgs.append(imgs).append(true) gm convert src imgs +append
   *    imgs.append(imgs).background('#222) gm convert src imgs -background #222 +append
   *    imgs.append([img1,img2...],true)

   * @param {String} or {Array} [imgs]
   * @param {Boolean} [ltr]
